...
ПОЛЕЗНОЕ НАЧИНАЮЩИМ
* Ступенчатые сверла 3шт, доставили СДЭКом: http://alii.pub/63m86j
* Обжимка (выбирай SN-2549 720H), там же разъемы и другие стандарты обжимок: http://alii.pub/63m892
* Очиститель жала: http://alii.pub/63m8b0
* Отличный припой: http://alii.pub/63m8xd
* ESR meter (проверка компонентов): http://alii.pub/63m8zi
* Макетная плата: http://alii.pub/63m91n
* Перемычки Dupont: http://alii.pub/63m92m
* Паяльник 12-24В SH72: http://alii.pub/63m92t
* USB паяльник: http://alii.pub/63m93e
* Флюс-гель: http://alii.pub/63m94d
* Термоклей для радиаторов: http://alii.pub/63m95j
* Термоусадочные трубки, набор: http://alii.pub/63m96w
* Набор клемм: http://alii.pub/63m97v
